%Jędrzej Biedrzycki 6504
%
% Początkowo co prawda groza z rozbijaniem zdania na akapity, ale ze wskazówkami domyslił sie i poprawił.
% Dla mnie: przeanalizować to miejsce amsmath, które powoduje, że w przeciwieństwie do zwykłego LaTeX-a złe użycie jest widoczne.
% W CV fonty jak z Auschwitz, ale poprawione.
% I na celującą zrobił stopniową zmiane koloru.
%
% 5,5 celuj
%
...
\declaretheoremstyle[headindent=15pt, headfont=\scshape, bodyfont=\itshape]{theoremstyle}
